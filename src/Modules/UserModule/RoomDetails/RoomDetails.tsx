...
export default function RoomDetails() {
  ...
  const total = useMemo(() => nights * nightlyRate, [nights]);
  const blue = "#203FC7";
  const HEADER_H = 56;
  const textFieldSX = {
  ...
  const validateBooking = (): boolean => {
    ...
    if (!checkIn) nextErrors.checkIn = "Please choose a check-in date.";
    if (!checkOut) nextErrors.checkOut = "Please choose a check-out date.";
    ...
    if (checkIn && checkOut) {
      ...
      if (diff <= 0) {
        ...
        nextErrors.checkOut = `Maximum stay is ${maxNights} nights.`;
      }
    }
        ...
        <Grid container spacing={2}>
          <Grid size={{ xs: 12, md: 8 }}>
            ...
            >
              <Box
                component="img"
                src={roomDetails?.images?.[0] || nopic}
            ...
            <Grid container spacing={2} direction="column">
              <Grid>
                ...
                >
                  <Box
                    component="img"
                    src={roomDetails?.images?.[1] || nopic}
                    alt={`Room ${roomDetails?.roomNumber ?? ""}`}
                    sx={{
                      width: "100%",
                      height: "100%",
              ...
              <Grid>
                ...
                >
                  <Box
                    component="img"
                    src={roomDetails?.images?.[2] || nopic}
                    alt={`Room ${roomDetails?.roomNumber ?? ""}`}
                    sx={{
                      width: "100%",
                      height: "100%",
          ...
          <Grid size={{ xs: 12, md: 4 }}>
            ...
            >
              <Stack spacing={2}>
                ...
                <Typography variant="h6" color="#2e54e3" textAlign={"center"}>
                  {nights > 0
                    ? `You will pay $${total} USD for ${nights} ${
                ...
                <Button
                  ...
                  disabled={nights <= 0 || nights > maxNights} 
                  sx={{
                    mt: 1,
                    borderRadius: 2,
                    fontWeight: 700,
