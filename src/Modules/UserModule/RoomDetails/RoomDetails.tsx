...
import bigImage from "../../../Images/img1.png";
import smallphoto2 from "../../../Images/img2.png";
import smallphoto3 from "../../../Images/img3.png";
...
import "dayjs/locale/ar"; // for Arabic if you switch languages
...
const HEADER_H = 56; 
  const textFieldSX = {
    "& .MuiOutlinedInput-root": {
      ...
      "&.Mui-focused fieldset": { borderColor: blue, boxShadow: "0 0 0 2px rgba(32,63,199,.08)" },
    },
  } as const;
  return (
    <Box sx={{ px: { xs: 2, sm: 3 }, py: 3, maxWidth: 1200, mx: "auto" }}>
      ...
      {/* Description + Booking */}
      {/* Description + Booking (below gallery) */}
      <Grid container spacing={2} sx={{ mt: 3 }}>
        <Grid size={{ xs: 6, md: 8 }}>
          <Stack spacing={1}>
            <Typography variant="body1" lineHeight={1.6} color="text.secondary"
     sx={{ fontWeight: 500 , fontSize:15}}>              Minimal techno is a minimalist subgenre of techno music. It is
            ...
            <Typography variant="body1" lineHeight={1.6} color="text.secondary"
     sx={{ fontWeight: 500 , fontSize:15}}>              Such trends saw the demise of the soul-infused techno that
        ...
        <Grid size={{ xs: 6, md: 3 }}>
         ...
         <Grid size={{ xs: 6, sm: 3 }}>
              <Stack alignItems="center" spacing={1.2}>
                <RestaurantIcon sx={{ fontSize: 26, color: "text.secondary" }} />
                <Typography variant="body2" color="text.secondary">
                  <b>1</b> dining room
                </Typography>
              </Stack>
    ...
    />
              ...
              <Button
                ...
                sx={{
                  ...
                  textTransform: "none",
                  backgroundImage:
                    "linear-gradient(180deg, #3D6CFF 0%, #2647D4 100%)",
                  boxShadow: "0 6px 16px rgba(61,108,255,0.35)",
                  "&:hover": {
                    backgroundImage:
                      "linear-gradient(180deg, #325FF5 0%, #2040C8 100%)",
      ...
      <Grid container alignItems="stretch" spacing={4}>
        ...
        <Grid size={{ xs: 12, md: 5.5 }} >
          <Stack spacing={2.5} height="100%">
                 <Box sx={{ minHeight: HEADER_H, display: "flex", alignItems: "center", gap: 1 }}>
       ...
       <Stack spacing={2.5} height="100%">
      <Box sx={{ minHeight: HEADER_H, display: "flex", alignItems: "center" }}>
